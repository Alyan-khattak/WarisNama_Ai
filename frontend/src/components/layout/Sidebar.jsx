...
const Sidebar = () => {
  ...
  return (
    <aside className="w-64 bg-white shadow-xl flex flex-col z-10">
      <div className="p-5 border-b border-gray-100">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 bg-gradient-to-br from-green-200 to-green-600 rounded-lg flex items-center justify-center">
            {/* You can add an icon or text here if needed */}
          </div>
          <h1 className="text-2xl font-bold mb-7" style={{ color: '#0c6e30' }}>
            WarisNama AI
          </h1>
        </div>
        <p className="text-xs text-gray-500 mt-1">Inheritance Resolution</p>
              ...
              <li key={item.path}>
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 ${
                      isActive
                        ? 'bg-gradient-to-r from-green-50 to-emerald-50 text-green-700 shadow-sm border-r-4 border-green-600'
      ...
      {/* ========== IMAGE ADDED HERE - UNDER CHATBOT ========== */}
      <div className="px-4 pb-4">
        <div className="rounded-xl overflow-hidden shadow-md border border-gray-100 bg-gradient-to-br from-green-50 to-emerald-50">
          <img 
      ...
      <div className="p-4 border-t border-gray-100">
        <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-3 text-center">
          <p className="text-xs text-gray-500">Powered by</p>
          <p className="text-sm font-semibold text-green-800">WarisNama AI</p>
        </div>
      </div>
    </aside>
  )
